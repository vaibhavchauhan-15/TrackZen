  ...
  return (
    <div className="mx-auto max-w-5xl space-y-3 sm:space-y-6 animate-in pb-20 sm:pb-6">
      ...
      <Tabs value={currentTab} onValueChange={setCurrentTab} className="w-full">
        <TabsList className="grid w-full grid-cols-2 bg-bg-surface/80 backdrop-blur-sm p-1.5 rounded-xl overflow-hidden h-14 shadow-lg shadow-purple-900/10 border border-purple-500/10 gap-1">
          <TabsTrigger 
            value="manual" 
            disabled={isGenerating}
            className="touch-ripple data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500/30 data-[state=active]:to-purple-600/25 data-[state=active]:text-purple-100 data-[state=active]:shadow-lg data-[state=active]:shadow-purple-500/20 rounded-lg transition-all duration-150 ease-out group text-sm font-semibold h-full flex items-center justify-center gap-2 active:scale-[0.97] will-change-transform"
          >
            <Calendar className="h-5 w-5 group-data-[state=active]:text-purple-300 transition-colors duration-150" />
            <span>{isAiGenerated ? 'Review' : 'Topics'}</span>
          </TabsTrigger>
          <TabsTrigger 
            value="ai" 
            disabled={isGenerating || isAiGenerated}
            className="touch-ripple data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500/30 data-[state=active]:to-blue-500/25 data-[state=active]:text-purple-100 data-[state=active]:shadow-lg data-[state=active]:shadow-purple-500/20 rounded-lg transition-all duration-150 ease-out group text-sm font-semibold h-full flex items-center justify-center gap-2 disabled:opacity-40 active:scale-[0.97] will-change-transform"
          >
            <Sparkles className="h-5 w-5 group-data-[state=active]:text-purple-300 group-data-[state=active]:animate-pulse transition-colors duration-150" />
        ...
        {isGenerating && (
          <Card className="mt-3 border-purple-500/50 bg-gradient-to-r from-purple-950/50 to-blue-950/50 overflow-hidden animate-slideInUp">
            ...
            <CardContent className="pt-4 pb-4 px-4 relative">
              <div className="flex items-start gap-3">
                <div className="relative flex-shrink-0">
                  <div className="animate-spin rounded-full h-11 w-11 border-2 border-purple-500/30 border-t-purple-500"></div>
                  <Sparkles className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-5 w-5 text-purple-400" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-2 mb-2">
                    <p className="font-semibold text-purple-100 text-sm truncate">{generationProgress}</p>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => {
                      ...
                      className="text-red-400 hover:text-red-300 hover:bg-red-500/15 transition-all duration-150 text-xs h-8 px-3 flex-shrink-0 active:scale-95 will-change-transform"
                    >
                      Cancel
                    </Button>
                  </div>
                  <div className="h-2 bg-purple-950/50 rounded-full overflow-hidden">
                    <div 
                      className="h-full bg-gradient-to-r from-purple-500 to-blue-500 rounded-full transition-all duration-200 ease-out will-change-transform"
              ...
              {streamStats.topics > 0 && (
                <div className="flex flex-wrap items-center gap-2 mt-4 pt-4 border-t border-purple-500/20">
                  <span className="px-2.5 py-1.5 rounded-lg bg-purple-500/15 text-purple-300 text-xs font-semibold">
                    📚 {streamStats.topics} topics
                  </span>
                  <span className="px-2.5 py-1.5 rounded-lg bg-blue-500/15 text-blue-300 text-xs font-semibold">
                    📝 {streamStats.subtopics} subtopics
                  </span>
                  <span className="px-2.5 py-1.5 rounded-lg bg-green-500/15 text-green-300 text-xs font-semibold">
        ...
        {isAiGenerated && !isGenerating && topics.length > 0 && (
          <Card className="mt-3 border-green-500/40 bg-gradient-to-r from-green-950/40 to-emerald-950/40 animate-slideInUp overflow-hidden">
            ...
            <CardContent className="pt-4 pb-4 px-4 relative">
              <div className="flex items-center gap-3">
                <div className="p-2.5 rounded-xl bg-gradient-to-br from-green-500/20 to-emerald-500/15 shadow-lg shadow-green-500/10 flex-shrink-0">
                  <Sparkles className="h-5 w-5 text-green-400" />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="font-semibold text-green-100 text-sm">✨ AI Plan Generated!</p>
                  <p className="text-sm text-green-300/80 mt-0.5 line-clamp-1">
        ...
        <TabsContent value="manual" className="space-y-3 animate-tabSwitch mt-3">
          <Card className="glow-interactive overflow-hidden border-purple-500/15">
            <CardHeader className="p-4 pb-3">
              <div className="flex items-center justify-between gap-3">
                <div className="min-w-0 flex-1">
                  <CardTitle className="flex items-center gap-2.5 text-base">
                    <span className="p-2 rounded-xl bg-gradient-to-br from-purple-500/20 to-purple-600/10 shadow-inner flex-shrink-0">
                      <Plus className="h-5 w-5 text-purple-400" />
                    </span>
                    <span className="bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent font-bold">Topics & Subtopics</span>
                  </CardTitle>
                  <CardDescription className="mt-2.5 space-y-2">
                    <span className="text-xs text-text-secondary block">Add topics with priorities.</span>
                    <span className="inline-flex items-center gap-1.5 text-xs font-medium text-purple-300 bg-gradient-to-r from-purple-950/60 to-purple-900/40 px-2.5 py-1.5 rounded-lg border border-purple-700/40">
                ...
                <AnimatedAddButton 
                  ...
                  onClick={addTopic} 
                  size="sm"
                  className="flex-shrink-0 shadow-lg shadow-purple-500/20 h-10 min-w-[64px]"
                />
              </div>
            </CardHeader>
            <CardContent className="px-4 pb-4">
              {topics.length === 0 ? (
                <div className="text-center py-10 animate-fadeIn">
                  <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-500/15 to-purple-600/10 mb-4">
                    <Plus className="h-6 w-6 text-purple-400/70" />
                  </div>
                  <p className="text-sm text-text-secondary font-medium">No topics added yet</p>
                  <p className="text-xs text-text-secondary/70 mt-1">Tap "Add" to start building your plan</p>
                </div>
              ) : (
                <div className="space-y-3 stagger-children">
                  {topics.map((topic, topicIndex) => {
                    ...
                    <Card 
                      key={topicIndex} 
                      className={`border transition-all duration-150 ease-out touch-ripple will-change-transform ${
                        isCurrentStreaming
                    ...
                    >
                      ...
                      {!isExpanded && (
                        <div 
                          className="p-3.5 flex items-center justify-between cursor-pointer active:bg-purple-950/30 hover:bg-purple-950/20 transition-colors duration-150 group gap-3 min-h-[68px]"
                          onClick={() => toggleTopicExpand(topicIndex)}
                        >
                          <div className="flex items-center gap-3 flex-1 min-w-0">
                            <div className="p-2 rounded-lg bg-purple-500/10 flex-shrink-0">
                              <ChevronRight className="h-5 w-5 text-purple-400 transition-transform duration-150 group-hover:translate-x-0.5" />
                            </div>
                            <div className="flex-1 min-w-0">
                              <h3 className="font-semibold text-sm text-text-primary group-hover:text-purple-200 transition-colors duration-150 truncate">
                                {topic.title || `Topic ${topicIndex + 1}`}
                              </h3>
                              <div className="flex items-center gap-2 mt-1 flex-wrap">
                                <span className="text-xs text-purple-400 font-medium whitespace-nowrap tabular-nums">
                                  {(topic.estimatedHours || 0).toFixed(1)}h • {topic.subtopics.length} sub
                                </span>
                                <span className={`text-[10px] px-2 py-0.5 rounded-full font-medium transition-colors duration-150 whitespace-nowrap ${
                                  hasInvalidSubtopics 
                          ...
                          <div className="flex items-center gap-2 flex-shrink-0">
                            <Button
                              variant="ghost"
                              size="sm"
                              className="hidden sm:flex bg-purple-500/10 hover:bg-purple-500/20 transition-all duration-150 h-9 px-3 text-xs text-purple-300"
                              onClick={(e) => {
                                e.stopPropagation()
                            ...
                            <Button
                              ...
                              className="hover:bg-red-500/15 active:bg-red-500/25 transition-colors duration-150 group/delete h-10 w-10"
                            >
                      ...
                      {/* Expanded Content */}
                      {isExpanded && (
                      <CardContent className="pt-4 px-4 pb-4 space-y-4 animate-expandContent">
                        {/* Header with collapse button */}
                        <div className="flex items-center justify-between pb-3 border-b border-purple-500/20">
                          <div className="flex items-center gap-2">
                            <span className="text-xs font-bold text-purple-300 bg-gradient-to-r from-purple-500/20 to-purple-600/15 px-2.5 py-1 rounded-lg">
                              #{topicIndex + 1}
                            </span>
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() => toggleTopicExpand(topicIndex)}
                            className="bg-green-500/10 hover:bg-green-500/20 text-green-400 hover:text-green-300 transition-all duration-150 h-10 text-sm px-4 active:scale-95 will-change-transform"
                          >
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex flex-col gap-3">
                            <div className="flex-1 input-focus-glow rounded-lg">
                              <Label className="text-sm font-medium">Topic Title <span className="text-red-400">*</span></Label>
                              <Input
                                value={topic.title}
                                onChange={(e) => updateTopic(topicIndex, 'title', e.target.value)}
                                placeholder="e.g., Data Structures"
                                className="mt-1.5 transition-all duration-150 focus:ring-2 focus:ring-purple-500/50 hover:border-purple-400/40 h-11 text-sm"
                              />
                            </div>
                            <div className="flex items-end gap-3">
                              <div className="flex-1 px-3 py-3 rounded-xl bg-gradient-to-br from-purple-500/15 to-blue-500/15 border border-purple-500/25 shadow-lg shadow-purple-500/5">
                                <div className="flex items-center justify-between">
                                  <span className="text-xs text-purple-400 font-medium">Total Hours</span>
                              ...
                              <Button
                                ...
                                className="hover:bg-red-500/15 active:bg-red-500/25 transition-colors duration-150 group/delete h-11 w-11 flex-shrink-0"
                              >
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            <div className="input-focus-glow rounded-lg">
                              ...
                              <Input
                                ...
                                disabled
                                placeholder="Auto"
                                className="mt-1.5 text-sm font-semibold bg-muted/50 cursor-not-allowed opacity-70 h-11"
                              />
                            </div>
                            <div>
                              ...
                              >
                                <SelectTrigger className="mt-1.5 transition-all duration-150 hover:border-purple-400/40 h-11 text-sm">
                                  <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                                  <SelectItem value="1">
                        ...
                        {/* Subtopics */}
                        <div className="space-y-3 border-l-2 border-purple-500/30 pl-3 transition-all duration-150">
                          <div className="flex items-center justify-between gap-2">
                            <button
                              onClick={() => toggleSubtopicsExpand(topicIndex)}
                              className="flex items-center gap-2 text-sm font-semibold text-purple-300 hover:text-purple-200 transition-colors duration-150 py-1 active:opacity-80"
                            >
                              <ChevronDown 
                              ...
                              {hasSubtopics && (
                                <span className="text-xs font-normal text-purple-400/80 bg-purple-500/10 px-2 py-0.5 rounded-full">
                            ...
                            <Button
                              ...
                              className="border-purple-500/30 bg-purple-500/5 hover:bg-purple-500/15 hover:border-purple-400/50 transition-all duration-150 group/add h-10 text-xs px-3 active:scale-95 will-change-transform"
                            >
                              <Plus className="mr-1 h-3.5 w-3.5 group-hover/add:rotate-90 transition-transform duration-150" />
                              Add
                            </Button>
                          </div>
                          ...
                          {topic.subtopics.map((subtopic, subtopicIndex) => (
                            <div 
                              key={subtopicIndex} 
                              className="flex items-start gap-2.5 p-3.5 rounded-xl bg-gradient-to-r from-purple-500/5 to-blue-500/5 border border-purple-500/15 hover:border-purple-500/30 transition-all duration-150 active:bg-purple-500/10 group/subtopic"
                            >
                              <div className="flex-1 space-y-2.5">
                                <Input
                                  ...
                                  className="border-purple-500/20 focus:border-purple-400/50 focus:ring-purple-500/40 transition-all duration-150 h-11 text-sm"
                                  required
                                />
                                <div className="grid grid-cols-2 gap-2.5">
                                  <div className="relative">
                                    <Input
                                      ...
                                      placeholder="Hours *"
                                      className="text-sm font-semibold border-purple-500/20 focus:border-purple-400/50 focus:ring-purple-500/40 transition-all duration-150 h-11"
                                      required
                                    />
                                  ...
                                  >
                                    <SelectTrigger className="border-purple-500/20 transition-all duration-150 h-11 text-sm">
                                      <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
                              ...
                              <Button
                                ...
                                className="hover:bg-red-500/15 active:bg-red-500/25 transition-colors duration-150 disabled:opacity-30 disabled:cursor-not-allowed h-11 w-11 flex-shrink-0 mt-auto"
                          ...
                          {topic.subtopics.length === 1 && areSubtopicsExpanded && (
                            <p className="text-xs text-amber-400/80 italic flex items-center gap-1.5 pt-2 animate-fadeIn">
        ...
        <TabsContent value="ai" className="space-y-3 animate-tabSwitch mt-3">
          <Card className="glow-interactive overflow-hidden group/ai border-purple-500/15">
            <div className="absolute -top-20 -right-20 w-40 h-20 bg-purple-500/10 rounded-full blur-3xl group-hover/ai:bg-purple-500/20 transition-all duration-300" />
            <CardHeader className="relative p-4 pb-3">
              <CardTitle className="flex items-center gap-3 text-base">
                <span className="p-2.5 rounded-xl bg-gradient-to-br from-purple-500/25 to-purple-600/15 shadow-lg shadow-purple-500/10">
                  <Sparkles className="h-5 w-5 text-purple-400" />
                </span>
                <span className="bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent font-bold">AI Study Plan Generator</span>
              </CardTitle>
              <CardDescription className="text-sm mt-2.5 text-text-secondary leading-relaxed">
                Describe your goal and let AI create a personalized plan
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4 relative px-4 pb-5">
              <div className="input-focus-glow rounded-xl">
                <Label htmlFor="ai-prompt" className="text-sm font-medium text-text-secondary">What do you want to study?</Label>
                <Textarea
                  id="ai-prompt"
                  ...
                  rows={4}
                  className="mt-2.5 min-h-[100px] transition-all duration-150 focus:ring-2 focus:ring-purple-500/50 hover:border-purple-400/40 resize-none text-sm leading-relaxed placeholder:text-text-secondary/50"
                />
              </div>
              <AnimatedButton 
                ...
                variant="primary"
                className="w-full btn-shine h-12 text-base font-semibold active:scale-[0.98] transition-transform will-change-transform"
              >
                <Sparkles className="h-5 w-5" />
                {isGenerating ? 'Generating...' : 'Generate Plan'}
              </AnimatedButton>
              {topics.length > 0 && !isAiGenerated && (
                <p className="text-xs text-amber-400/80 animate-fadeIn flex items-center gap-1.5 justify-center">
      ...
      <Card className={`glow-interactive overflow-hidden transition-all duration-200 border-purple-500/15 ${isAiGenerated && topics.length > 0 ? 'border-2 border-purple-500/40 shadow-xl shadow-purple-500/10' : ''}`}>
        <CardContent className="pt-4 pb-5 px-4 relative">
          {isAiGenerated && topics.length > 0 && (
            <div className="mb-4 p-4 bg-gradient-to-r from-purple-950/60 to-purple-900/40 rounded-xl border border-purple-500/30 animate-fadeIn">
          ...
          <div className="flex flex-col gap-3">
            {isAiGenerated && (
              <Button 
                ...
                disabled={isCreating}
                className="w-full border-purple-500/30 bg-purple-500/5 hover:bg-purple-500/15 hover:border-purple-400/50 transition-all duration-150 h-10 text-sm font-medium active:scale-[0.98] will-change-transform"
              >
            ...
            <div className="flex gap-3 justify-left">
              <AnimatedButton 
                ...
                variant="primary"
                className="flex-1 max-w-[160px] justify-center h-10 text-sm font-semibold btn-shine active:scale-[0.98] transition-transform will-change-transform"
              >
                {isCreating ? (
                  <>
              ...
              <Button 
                ...
                className="flex-1 max-w-[160px] hover:bg-red-500/10 hover:border-red-500/40 hover:text-red-400 transition-all duration-150 h-12 text-sm font-medium active:scale-[0.98] will-change-transform"
              >
                Cancel
              </Button>
            </div>
          ...
          <div className="flex items-center justify-between gap-3 mt-4 pt-4 border-t border-border/30">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="px-2.5 py-1.5 rounded-lg bg-blue-500/15 text-blue-300 text-xs font-semibold tabular-nums">
